...
//   // Parse ticket_types
//   const parsedTicketTypes = ticket_types.map(ticketType => JSON.parse(ticketType));  
...
//       // Ensure ticket_types is a string array
//       const ticketTypesAsStrings = parsedTicketTypes.map(ticketType => JSON.stringify(ticketType));
//       values.push(ticketId, booking_id, event_id, ticketTypesAsStrings, "confirm", qrCode, barcode, user_name);
//       placeholders.push(
